...
import "./device-registration-flow-builder-banner.scss";

/**
 * Props interface of {@link DeviceRegistrationFlowBuilderBanner}
 */
type DeviceRegistrationFlowBuilderBannerProps = IdentifiableComponentInterface;

/**
 * Component to display the registration flow builder banner.
 *
 * @param props - Props injected to the component.
 * @returns The DeviceRegistrationFlowBuilderBanner component.
 */
const DeviceRegistrationFlowBuilderBanner: FC<DeviceRegistrationFlowBuilderBannerProps> = ({
    "data-componentid": componentId = "device-registration-flow-builder-banner"
}: DeviceRegistrationFlowBuilderBannerProps) => {
    ...
    return (
        <Card
            ...
            className="device-registration-flow-builder-banner"
...
export default DeviceRegistrationFlowBuilderBanner;
