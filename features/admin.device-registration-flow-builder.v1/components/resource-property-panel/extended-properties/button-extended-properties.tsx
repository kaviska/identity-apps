...
import useGetDeviceRegistrationFlowCoreActions from "../../../api/use-get-device-registration-flow-builder-actions";
...
const ButtonExtendedProperties: FunctionComponent<ButtonExtendedPropertiesPropsInterface> = ({
    ...
    const { data: actions } = useGetDeviceRegistrationFlowCoreActions();
