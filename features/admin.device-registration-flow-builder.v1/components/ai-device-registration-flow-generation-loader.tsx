...
import useAIDeviceRegistrationFlowGenerationStatus from "../api/use-ai-device-registration-flow-status";
import {
    ...
    useGetFacts,
    useGetStatusLabels
} from "../constants/device-registration-flow-ai-constants";
import useAIGeneratedDeviceRegistrationFlow from "../hooks/use-ai-generated-device-registration-flow";

const DeviceRegistrationFlowAILoader = (): ReactElement => {
    ...
    const { data, error } = useAIDeviceRegistrationFlowGenerationStatus();
...
export default DeviceRegistrationFlowAILoader;
