...
/**
 * Props interface of {@link DeviceRegistrationFlowBuilderContext}
 */
export interface DeviceRegistrationFlowBuilderContextProps {
    /**
 ...
 */
const DeviceRegistrationFlowBuilderContext: Context<
    DeviceRegistrationFlowBuilderContextProps
> = createContext<null | DeviceRegistrationFlowBuilderContextProps>(
    {
        isPublishing: false,
...
DeviceRegistrationFlowBuilderContext.displayName = "DeviceRegistrationFlowBuilderContext";

export default DeviceRegistrationFlowBuilderContext;
