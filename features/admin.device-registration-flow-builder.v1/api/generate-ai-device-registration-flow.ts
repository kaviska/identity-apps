 ...
 */
const generateDeviceRegistrationFlow = (
    userQuery: string,
    traceId: string
): Promise<any> => {
    const requestConfig: AxiosRequestConfig = {
        data: {
            flow_type: DeviceRegistrationFlowConstants.DEVICE_REGISTRATION_FLOW_TYPE,
        ...
        url: `${ store.getState().config.endpoints.deviceRegistrationFlowAI }/generate`
    };
...
export default generateDeviceRegistrationFlow;
