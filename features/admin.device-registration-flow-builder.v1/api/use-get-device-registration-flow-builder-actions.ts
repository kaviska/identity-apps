 ...
 * This hook will aggregate the core actions and the registration specific actions.
 *
 ...
 */
const useGetDeviceRegistrationFlowBuilderActions = <Data = Actions, Error = RequestErrorInterface>(
...
export default useGetDeviceRegistrationFlowBuilderActions;
