 ...
 */
const useGetDeviceRegistrationFlowBuilderResources = <Data = Resources, Error = RequestErrorInterface>(
...
export default useGetDeviceRegistrationFlowBuilderResources;
