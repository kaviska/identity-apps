...
import useAIGeneratedDeviceRegistrationFlow from "./use-ai-generated-device-registration-flow";
import generateDeviceRegistrationFlow from "../api/generate-ai-device-registration-flow";

export type UseGenerateDeviceRegistrationFlowFunction = (
    userQuery: string,
    traceId: string
) => Promise<void>;

const useGenerateDeviceRegistrationFlow = (): UseGenerateDeviceRegistrationFlowFunction => {
     ...
     */
    const generateAIDeviceRegistrationFlow = async (
        userQuery: string,
        traceId: string
    ): Promise<void> => {

        return generateDeviceRegistrationFlow(userQuery, traceId)
            .then((data: any) => {
    ...
    return generateAIDeviceRegistrationFlow;
};

export default useGenerateDeviceRegistrationFlow;
