 ...
 * @example
 * ```typescript
 * const executor = DeviceRegistrationFlowExecutorConstants.PASSWORD_PROVISIONING_EXECUTOR;
 * ```
 */
class DeviceRegistrationFlowExecutorConstants {
    /**
...
export default DeviceRegistrationFlowExecutorConstants;
